...
def swap_colors(circle, rectangle):
    ...
    ####################################################################
    # ------------------------------------------------------------------
    circle_color_original = circle.fill_color
    rect_color_original = rectangle.fill_color
    circle.fill_color = rect_color_original
    rectangle.fill_color = circle_color_original
